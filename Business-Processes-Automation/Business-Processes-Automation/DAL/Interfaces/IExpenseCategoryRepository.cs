...
public interface IExpenseCategoryRepository
{
    ...
    Task<ExpenseCategory> CreateAsync(ExpenseCategory entity, CancellationToken cancellationToken = default);
    Task<ExpenseCategory> UpdateAsync(ExpenseCategory entity, CancellationToken cancellationToken = default);
